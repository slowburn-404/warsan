...
data class VaccineAdministration(
    @SerializedName("vaccine") val vaccine: Int,
    @SerializedName("date_of_administration") val dateOfAdministration: String
)

data class VaccinatedChild(
    @SerializedName("id") val id: Int,
    @SerializedName("vaccineadministration_set") val vaccineAdministrationSet: List<VaccineAdministration>,
