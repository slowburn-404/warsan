 ...
 * Use the [TwelveToEighteenMonthsFragment.newInstance] factory method to
...
class TwelveToEighteenMonthsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment TwelveToEighteenMonthsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TwelveToEighteenMonthsFragment().apply {
